...
//time  big 和 small 转换函数
    ...
    fun currentMonthAndDayStyle1(watchType: Int) : Array<Int> {
        ...
        Log.d("ts_wj", "currentMonthAndDayStyle1: "+month)
        val day = Calendar.getInstance().get(Calendar.DAY_OF_MONTH)
        Log.d("ts_wj", "currentMonthAndDayStyle1: "+day)
        //判断当前的是否需要显示分隔符
        drawableResArray[2] = R.drawable.camera_wf_style1_date_digital_spit_sign
        //小时和分钟十位和各位
        val monthTen  = month / 10 % 10
        Log.d("ts_wj", "currentMonthAndDayStyle1: "+monthTen)
        val monthBit = month % 10
        Log.d("ts_wj", "currentMonthAndDayStyle1: "+monthBit)
        val dayTen = day / 10 %10
        Log.d("ts_wj", "currentMonthAndDayStyle1: "+dayTen)
        val dayBit = day % 10
        Log.d("ts_wj", "currentMonthAndDayStyle1: "+dayBit)
        //将图片放置在对应的位置
